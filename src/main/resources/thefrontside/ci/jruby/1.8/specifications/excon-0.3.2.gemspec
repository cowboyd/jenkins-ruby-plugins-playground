...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile", "README.rdoc", "Rakefile", "benchmarks/concat_vs_insert.rb", "benchmarks/concat_vs_interpolate.rb", "benchmarks/cr_lf.rb", "benchmarks/excon_vs.rb", "benchmarks/headers_split_vs_match.rb", "benchmarks/strip_newline.rb", "excon.gemspec", "lib/excon.rb", "lib/excon/connection.rb", "lib/excon/errors.rb", "lib/excon/response.rb", "tests/config.ru", "tests/test_helper.rb", "tests/threaded_tests.rb"]
